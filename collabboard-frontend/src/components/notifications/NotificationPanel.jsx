...
const NotificationPanel = ({ notifications, loading, onMarkRead, onMarkAllRead }) => {
      ...
      <div className="max-h-96 overflow-y-auto">
        ...
        {!loading &&
          notifications.map((n) => (
            ...
            >
              {/* Actor avatar */}
              <span className="bg-indigo-500 text-white text-xs font-bold w-8 h-8 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
